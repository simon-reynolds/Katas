...
[<assembly: AssemblyTitleAttribute("Katas.Tests")>]
[<assembly: AssemblyProductAttribute("Katas")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "Katas.Tests"
    let [<Literal>] AssemblyProduct = "Katas"
